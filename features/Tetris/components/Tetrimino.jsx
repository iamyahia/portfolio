/* Seven small square components */

import { Box } from "@react-three/drei";
import React from "react";
import { BoxGeometry } from "three";

// Seven types of Tetris
...
// The whole composed of all blocks
export const Tetrimino = ({ type, position, blocks, scale = 1 }) => {
  ...
  return (
    <group position={position} scale={[scale, scale, scale]}>
      ...
      <mesh receiveShadow position={[0, -0.1, 0]} visible={false}></mesh>
    </group>
  );
};
